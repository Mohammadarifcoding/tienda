...
const HomeCard = () => {
    return (
        <div>
            ...
            <h1>Some Favourite Things are</h1>

            <div className="py-12">

            <div className="mx-auto max-w-[350px] space-y-4 rounded-lg bg-white p-5 shadow-lg md:w-[350px] dark:bg-[#18181B]">
        ...
        <img  className="h-[170px] w-[350px] rounded-lg object-cover" src="https://source.unsplash.com/200x200/?bed" alt="" />
        <div className="grid gap-2">
          ...
          <div className="text-lg font-semibold pb-1">$99.99</div>
        </div>
        ...
        <label className="font-medium peer-disabled:cursor-not-allowed peer-disabled:opacity-70 text-base" htmlFor="size">
                ...
                <div className="flex items-center gap-3" id="size">
                                    <select name="size"  className="select select-bordered border border-zinc-700 w-[300px] h-[44px]"  >
